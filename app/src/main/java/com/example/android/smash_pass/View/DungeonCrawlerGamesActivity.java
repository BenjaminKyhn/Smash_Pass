...
public class DungeonCrawlerGamesActivity extends AppCompatActivity {
    ...
    public void createButtons() {
        LinearLayout linearLayout = findViewById(R.id.dungeonCrawlerGamesLinearLayout);
        ...
        for (String key : dungeonCrawlerGamesMap.keySet()) {
            final VideoGame videoGame = dungeonCrawlerGamesMap.get(key);
